 ...
 * -------------------------------------------------------------------------------------------------
 * this is a fundamental module with no dependencies (apart from data)
 *
 * it includes HTML elements (canvas, console, etc.) which are exposed so that they can be included
 * in the page by the machine component
 *
 * the functions for modifying them are mostly kept within here, so only this module can access
 * them; the exception is the memory.dump function, which needs to be accessible to the application
 * as well
 * -------------------------------------------------------------------------------------------------
 */
