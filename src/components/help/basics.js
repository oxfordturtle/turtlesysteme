...
const BASIC = [
  ...
  create('pre', { content: `<code>${highlight('REM myprog  [this is a comment]\nREM [program commands]\nEND', 'BASIC')}</code>` }),
  ...
  create('pre', { content: `<code>${highlight('ringsize% = 130\nREM [other program commands]\nEND', 'BASIC')}</code>` }),
  ...
  create('pre', { content: `<code>${highlight('ringsize% = 130', 'BASIC')}</code>` }),
  ...
  create('table', {
    classes: ['tsx-help-table'],
    content: [
      create('tr', { content: `<td><code>${highlight('TURTX%', 'BASIC')}</code></td><td>The Turtle&rsquo;s x-coordinate</td>` }),
      create('tr', { content: `<td><code>${highlight('TURTY%', 'BASIC')}</code></td><td>The Turtle&rsquo;s y-coordinate</td>` }),
      create('tr', { content: `<td><code>${highlight('TURTD%', 'BASIC')}</code></td><td>The Turtle&rsquo;s direction</td>` }),
      create('tr', { content: `<td><code>${highlight('TURTT%', 'BASIC')}</code></td><td>The Turtle&rsquo;s pen thickness</td>` }),
      create('tr', { content: `<td><code>${highlight('TURTC%', 'BASIC')}</code></td><td>The Turtle&rsquo;s colour setting</td>` }),
    ]
  }),
  create('p', { content: 'These automatically change to keep track of the Turtle&rsquo;s state, and are shown above the Canvas.' }),
  create('p', { content: `For a use of <code>${highlight('TURTD%', 'BASIC')}</code>, see the &lsquo;Simple procedure&rsquo; example.` }),
];

const Pascal = [
  create('h3', { content: 'Programs and Procedures: the Basics' }),
  create('p', { content: 'The simplest Pascal programs take this form:' }),
  create('pre', { content: `<code>${highlight('PROGRAM myprog;\nBEGIN\n  {program commands}\nEND.', 'Pascal')}</code>` }),
  ...
  create('pre', { content: `<code>${highlight('Procedure myprocedure(par1: integer);\nVar local1, local2: integer;\nBegin\n  {procedure commands}\nEnd;', 'Pascal')}</code>` }),
  ...
  create('p', { content: `Notice that variable and constant declarations must all end with a semicolon – Turtle will tell you if you forget! Notice also that while constants are given a value when declared (e.g. <code>${highlight('limit', 'Pascal')}</code> is given the value <code>${highlight('4', 'Pascal')}</code> above), variables are given a <em>type</em>, to indicate the sort of data that they can store. Turtle Pascal allows four main types of variables:` }),
  create('table', {
    classes: ['tsx-help-table'],
    content: [
  ...
  create('pre', { content: `<code>${highlight('VAR ringsize: integer;', 'Pascal')}</code>` }),
  create('p', { content: `is declared in the &lsquo;Olympic rings 2&rsquo; example program, and <code>${highlight('ringsize', 'Pascal')}</code> is later assigned the value <code>${highlight('130', 'Pascal')}</code> using the command:` }),
  create('pre', { content: `<code>${highlight('ringsize := 130;', 'Pascal')}</code>` }),
  create('p', { content: 'Five special integer variables are &lsquo;built in&rsquo; from the start, and these are called the Turtle&rsquo;s fields:' }),
  create('table', {
    classes: ['tsx-help-table'],
    content: [
      create('tr', { content: `<td><code>${highlight('turtx', 'Pascal')}</code></td><td>The Turtle’s x-coordinate</td>` }),
      create('tr', { content: `<td><code>${highlight('turty', 'Pascal')}</code></td><td>The Turtle’s y-coordinate</td>` }),
      create('tr', { content: `<td><code>${highlight('turtd', 'Pascal')}</code></td><td>The Turtle’s direction</td>` }),
      create('tr', { content: `<td><code>${highlight('turtt', 'Pascal')}</code></td><td>The Turtle’s pen thickness</td>` }),
      create('tr', { content: `<td><code>${highlight('turtc', 'Pascal')}</code></td><td>The Turtle’s colour setting</td>` }),
    ]
  }),
  create('p', { content: 'These automatically change to keep track of the Turtle&rsquo;s state, and are shown above the Canvas.' }),
  create('p', { content: `For a use of <code>${highlight('turtd', 'Pascal')}</code>, see the &lsquo;Simple procedure&rsquo; example.` }),
];

const Python = [
  create('h3', { content: 'Programs and Procedures: the Basics' }),
  create('p', { content: 'The simplest Python programs take this form:' }),
  create('pre', { content: `<code>${highlight('# myprog  [this is a comment]\ndef main():\n  # program commands', 'Python')}</code>` }),
  ...
  create('pre', { content: `<code>${highlight('def outsidefunction(par1):\n  global global1, global2        # optional\n  nonlocal nonlocal1, nonlocal2  # optional\n\n  def insidefunction():\n    # insidefunction&rsquo;s commands\n\n  # outsidefunction&rsquo;s commands', 'Python')}` }),
  create('p', { content: `Nested functions must occur after any <code>${highlight('global', 'Python')}</code> or <code>${highlight('nonlocal', 'Python')}</code> declarations and before the function&rsquo;s commands. Functions may return a value like this:` }),
  create('pre', { content: `<code>${highlight('def fname(par1):\n  # function commands\n  return somevalue', 'Python')}</code>` }),
  create('p', { content: 'If there is no return statement then the function behaves like a procedure in Pascal or BASIC.' }),
  create('p', { content: `A function can also have parameters (or &lsquo;arguments&rsquo;) that are values sent into the subroutine when it is called from the program, and given a name within the subroutine (e.g. <code>${highlight('par1', 'Python')}</code> above).` }),
  create('h4', { content: 'Reserved Words, Declarations, Types, and Variables' }),
  ...
  create('pre', { content: `<code>${highlight('ringsize = 130', 'Python')}</code>` }),
  ...
  create('table', {
    classes: ['tsx-help-table'],
    content: [
      create('tr', { content: `<td><code>${highlight('turtx', 'Python')}</code></td><td>The Turtle&rsquo;s x-coordinate</td>` }),
      create('tr', { content: `<td><code>${highlight('turty', 'Python')}</code></td><td>The Turtle&rsquo;s y-coordinate</td>` }),
      create('tr', { content: `<td><code>${highlight('turtd', 'Python')}</code></td><td>The Turtle&rsquo;s direction</td>` }),
      create('tr', { content: `<td><code>${highlight('turtt', 'Python')}</code></td><td>The Turtle&rsquo;s pen thickness</td>` }),
      create('tr', { content: `<td><code>${highlight('turtc', 'Python')}</code></td><td>The Turtle&rsquo;s colour setting</td>` }),
    ]
  }),
  create('p', { content: 'These automatically change to keep track of the Turtle&rsquo;s state, and are shown above the Canvas.' }),
  create('p', { content: `For a use of <code>${highlight('turtd', 'Python')}</code>, see the &lsquo;Simple procedure&rsquo; example.` })
];
