...
module.exports = ([
    ...
    newCommand({
        ...
        code: pc.elps,
        parameters: [
            newParameter('Xradius', 'int'),
            newParameter('Yradius', 'int'),
        ],
        group: 2,
        level: 0,
    ...
    newCommand({
        ...
        parameters: [
            newParameter('x', 'int'),
            newParameter('y', 'int'),
            newParameter('colour', 'int'),
            newParameter('border', 'bool'),
        ],
        group: 2,
        level: 1,
    ...
    newCommand({
        ...
        code: pc.outp,
        parameters: [
            newParameter('clear', 'bool'),
            newParameter('colour', 'int'),
            newParameter('tofront', 'bool'),
        ],
        group: 3,
        level: 1,
    ...
    newCommand({
        ...
        code: pc.mixc,
        parameters: [
            newParameter('colour1', 'int'),
            newParameter('colour1', 'int'),
            newParameter('proportion1', 'int'),
            newParameter('proportion2', 'int'),
        ],
        returns: 'int',
        group: 3,
        level: 2,
    ...
    newCommand({
        ...
        code: pc.incr,
        parameters: [
            newParameter('variable', 'int', true),
        ],
        group: 5,
        level: 0,
    ...
    newCommand({
        ...
        parameters: [
            newParameter('str', 'str'),
            newParameter('font', 'int'),
            newParameter('size', 'int'),
        ],
        group: 7,
        level: 0,
    ...
    newCommand({
        ...
        parameters: [
            newParameter('str', 'str'),
            newParameter('index', 'int'),
            newParameter('length', 'int'),
        ],
        returns: 'str',
        group: 7,
        level: 2,
