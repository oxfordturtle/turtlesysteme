...
const basicText = `
  ...
  <p>The last statement of a function always begins with <code>${highlight('=', 'BASIC')}</code> and the <code>${highlight('"output"', 'BASIC')}</code> provides the return value for the function.</p>
...
const pascalText = `
  ...
  <p>is declared in the &lsquo;Olympic rings 2&rsquo; example program, and <code>${highlight('ringsize', 'Pascal')}</code> is later assigned the value <code>${highlight('130', 'Pascal')}</code> using the command:</p>
