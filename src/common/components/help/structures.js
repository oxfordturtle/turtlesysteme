...
const pascalText = `
  ...
  <p>If instead of looping a specific number of times, you want to loop through some sequence of commands until some particular condition becomes true, then you can use:' }),
  <pre><code>${highlight('repeat\n  {command1;}\n  {command2; (etc.)}\nuntil {condition}', 'Pascal')}</code></p>
